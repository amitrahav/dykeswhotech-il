    ...
    return (
        <section className="py-20 md:py-32 px-4 bg-[#8D6BE4] text-white text-center relative overflow-hidden rounded-[23px] rounded-b-[0px]">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <h2 className="text-3xl md:text-4xl font-black mb-2">Become a sponsor</h2>
                <h3 className="text-2xl md:text-3xl font-black text-[#FF66E0] mb-8">Join our proud partners</h3>
